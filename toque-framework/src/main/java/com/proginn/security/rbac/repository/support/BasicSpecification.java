 ...
 * 
 */
package com.proginn.security.rbac.repository.support;
 ...
 *
 */
public abstract class BasicSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
		implements Specification<T> {

	/**
	 * @param condition
	 */
	public BasicSpecification(C condition) {
		super(condition);
	}
