...
import com.proginn.security.rbac.repository.spec.AdminSpec;
...
public class AdminServiceImpl implements AdminService {
	...
	/* (non-Javadoc)
	 * @see com.proginn.security.rbac.service.AdminService#changePassword(java.lang.Long, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.proginn.security.rbac.service.AdminService#changeLanguage(java.lang.Long, com.proginn.security.i18n.LanguageType)
	 */
	@Override
	public void changeLanguage(Long id, LanguageType type) {
		Admin admin = adminRepository.findOne(id);
		admin.setLanguageType(type);
	}
